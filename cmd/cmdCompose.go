...
func ComposeCmd() *cobra.Command {
	...
	cmd := horus.Must(d.MakeCmd("compose", runCompose))

	cmd.Flags().StringVarP(&composeFlags.template, "template", "t", "", "Output file for the generated template (default: stdout)")
